export interface CellphoneProduct {
  ...
  quotes: string;
  url: string;
  Marca: "APPLE" | "SAMSUNG" | "MOTOROLA" | "XIAOMI" | "ONEPLUS";
  Modelo: string;
  Color: string;
  Pantalla: string;
  Procesador: string;
...
export const cellphoneCatalog: CellphoneProduct[] = [
  ...
  },
  {
    ...
    Camara_Frontal: "Single: 12 MP SL 3D Biométrico",
  ...
  {
    title: "Motorola Moto G84 5G 256GB Azul Metálico",
    price: "249.00 USD",
    quotes: "Sin cuotas",
    ...
    Resistencia_Agua: "IP54 protección a salpicaduras",
